		...
		<tr>
			<td align="center">
				<h1 style="line-height: 1.6; font-weight: bold;">
					Rincian Transaksi Infaq Anggota <br>
			...
			<table class="table table-bordered table-hover table-xs" border="1" cellspacing="0" width="100%">
				<thead class="thead-light">
					<tr>
						...
						<th style="text-align: center;">Tanggal Infaq</th>
				...
				<tbody>
					<?php 
					$i=1;
					if (is_array($bukuInfaqAnggota) || is_object($bukuInfaqAnggota))
					{
						foreach ($bukuInfaqAnggota as $fsa) :
							{
								$nominal = number_format($fsa->nominal);
								?>
								<tr>
									<td scope="row" width="3%" style="text-align: center;"><?= $i; ?></td>
									<td width="5%" style="text-align: center;"><?= $fsa->id_infaq; ?></td>
