...
<body>
   ...
   <table class="table table-bordered table-hover table-xs" border="1" cellspacing="0" width="100%">
    <thead>
     <tr>
      ...
      <th style="text-align: center;" scope="col-sm" bgcolor="white">Jenis Simpanan</th>
      <th style="text-align: center;" scope="col-sm" bgcolor="white">Tanggal Bayar</th>
  ...
  <tbody>
    <?php $i=1; ?>
    <?php foreach ($fakturSimpanan as $sa) : 
      {
        ...
        <tr id="example1_filter">
          ...
          <td width="20%" style="text-align: center;"><?= $sa['jenis_transaksi'];?></td>
          <td width="15%" style="text-align: center;"><?= $sa['tanggal']; ?></td>
