   ...
   <table class="table table-bordered table-hover table-xs" border="1" cellspacing="0" width="100%">
    <thead class="thead-dark">
     <tr>
      ...
      <th style="text-align: center;" scope="col-sm" bgcolor="white">Nomor Bagi Hasil</th>
    ...
    <?php foreach ($bhuAnggota as $bhu) : 
      {
        ...
        <tr id="example1_filter">
          ...
          <td width="5%" style="text-align: center;"><?= $bhu['id_bhu']; ?></td>
          <td width="5%" style="text-align: center;"><?= $bhu['id_transaksi']; ?></td>
          <td width="14%"><?= $bhu['name']; ?></td>
          <td width="13%" style="text-align: center;"><?= $bhu['tanggal']; ?></td>
