...
<body>
   ...
   <table class="table table-bordered table-hover table-xs" border="1" cellspacing="0" width="100%">
    <thead>
     <tr>
      ...
      <th style="text-align: center;">Nomor Bagi Hasil</th>
  ...
  <tbody>
    <?php $i=1; ?>
    <?php foreach ($fakturBhu as $fb) : 
    {
      $nominal1=number_format($fb['nominal'],0,",",".")
      ?>
      <tr id="example1_filter">
        <td scope="row" width="3%" style="text-align: center;"><?= $i; ?></td>                  
        <td width="10%" style="text-align: center;"><?= $fb['id_bhu']; ?></td>
        <td width="10%" style="text-align: center;"><?= $fb['id_transaksi']; ?></td>
        <td width="10%" style="text-align: center;">Rp. <?= $nominal1; ?></td>
        <td width="10%" style="text-align: center;"><?= $fb['tanggal']; ?></td>
      </tr>
      <?php $i++;?>
      <?php } ?>
      <?php endforeach; ?>
